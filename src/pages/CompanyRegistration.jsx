...
import CompanyRegistrationImage from "../assets/Company Registration.png"
...
>
  Apply Now
      ...
      {/* PROCESS */}
      <div className="max-w-4xl mx-auto px-4 sm:px-8 lg:px-[100px] py-[100px]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-[100px] py-[100px] grid md:grid-cols-2 gap-6">
        ...
        <div className="rounded-2xl border border-white/20 bg-white/[0.07] backdrop-blur-2xl shadow-[0_12px_32px_rgba(5,16,38,0.35),inset_0_1px_0_rgba(255,255,255,0.12)] p-6">
          ...
          <ul className="space-y-2 text-gray-400 text-sm">
            <li>Minimum 2 directors required</li>
            <li>Valid ID & address proof</li>
            <li>Registered office address</li>
            <li>Business activity clarity</li>
          </ul>
        ...
        <div className="rounded-2xl border border-white/20 bg-white/[0.07] backdrop-blur-2xl shadow-[0_12px_32px_rgba(5,16,38,0.35),inset_0_1px_0_rgba(255,255,255,0.12)] p-6">
          ...
          <div className="space-y-3">
            {["PAN Card", "Aadhaar Card", "Address Proof", "Passport Size Photos"].map((doc, i) => (

      ...
      <div className="login-shell">
        ...
        <div className="login-left">
          <div className="login-left-content">
            <img src="/home/Login.png" alt="T-HOME Login" className="login-illustration" />
          </div>
        </div>
        {/* Right: Login Form & Text */}
        <div className="login-right">
          <div className="login-form-container">
            <div className="login-logo-section">
              <div className="login-logo-ring">
                <img src="/home/logo.png" alt="T-HOME" className="login-logo-img" />
              </div>
            ...
            <div className="login-mode-switch" role="tablist" aria-label="Login mode">
              ...
              <button
                type="button"
                className={`login-mode-btn ${mode === "mobile" ? "login-mode-btn-active" : ""}`}
            ...
            <form onSubmit={handleLogin} className="login-form">
              <div className="login-field">
                ...
                <div className="login-input-wrapper">
                  ...
                  <input
                    ...
                    placeholder={mode === "email" ? "hello@example.com" : "Enter 10-digit mobile number"}
              ...
              <div className="login-field">
                ...
                <div className="login-input-wrapper">
                  ...
                  >
                    {showPassword ? <IconEyeOffDark /> : <IconEyeDark />}
                  </button>
                </div>
              </div>

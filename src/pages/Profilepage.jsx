...
const G = {
  ...
  input: {
    background:
      "linear-gradient(145deg, rgba(10,18,40,0.80) 0%, rgba(8,14,32,0.75) 100%)",
    ...
    <button
      ...
      style={{
        background: checked
          ...
          : "rgba(30,50,90,0.60)",
        border: checked
          ? "1px solid rgba(99,160,255,0.4)"
          : "1px solid rgba(80,130,220,0.20)",
...
function Card({ children, className = "" }) {
  return (
    <div className={`rounded-2xl p-6 ${className}`} style={G.card}>
      {children}
    </div>
  );
}
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 24px 64px rgba(0,0,0,0.7), inset 0 1px 0 rgba(120,170,255,0.10)",
        }}
      >
        <div
...
function parseDOB(str) {
  ...
  if (human) {
    const mIdx = MONTHS.findIndex((m) =>
      m.toLowerCase().startsWith(human[2].toLowerCase()),
    );
...
function DOBPicker({ value, onChange }) {
  ...
  function handleManualBlur() {
    ...
    if (p) {
      onChange(formatDOB(p));
      setManualVal(formatDOB(p));
    }
  }
    ...
    <div className="relative" ref={wrapRef}>
      ...
      <div
        ...
        style={{
          ...
          border:
            focused || calOpen
              ? "1px solid rgba(99,160,255,0.50)"
              : G.input.border,
          boxShadow:
            focused || calOpen
              ? "inset 0 2px 4px rgba(0,0,0,0.3), 0 0 0 3px rgba(59,130,246,0.12)"
      ...
      >
        <button
          type="button"
          onClick={() => {
            calOpen ? setCalOpen(false) : openCal();
          }}
      ...
      {calOpen && (
        <div
          style={{
            ...
            width: 300,
            background:
              "linear-gradient(145deg, rgba(10,18,38,0.98) 0%, rgba(6,12,28,0.99) 100%)",
            border: "1px solid rgba(80,130,220,0.28)",
            boxShadow:
              "0 16px 48px rgba(0,0,0,0.65), inset 0 1px 0 rgba(120,170,255,0.08)",
            borderRadius: 16,
          }}
        >
          {/* Month / Year nav */}
          <div
            ...
            style={{ borderBottom: "1px solid rgba(80,130,220,0.14)" }}
          >
            <button
              onClick={prevMonth}
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {MONTHS.map((m, i) => (
                  <option key={m} value={i} style={{ background: "#0d1b38" }}>
                    {m}
                  </option>
                ))}
              </select>
              ...
              >
                {years.map((y) => (
                  <option key={y} value={y} style={{ background: "#0d1b38" }}>
                    {y}
                  </option>
                ))}
              </select>
...
export default function Profilepage() {
  ...
  function handleDownload() {
    const blob = new Blob([JSON.stringify({ ...form, ...contact }, null, 2)], {
    ...
    >
      <div className="max-w-6xl mx-auto mb-8">
        ...
        <p className="text-sm text-slate-400 mt-1">
          Manage your personal information, KYC status, and preferences
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <Card>
          <div className="flex flex-col sm:flex-row sm:items-center gap-5">
            <div
              className="relative flex-shrink-0 self-start cursor-pointer group"
              ...
              <div
                ...
                style={{
                  background: avatar
                    ? "transparent"
                    : "linear-gradient(135deg,#3b82f6,#6366f1)",
                  border: "3px solid rgba(99,160,255,0.35)",
                  boxShadow: "0 0 20px rgba(99,130,255,0.30)",
                }}
              >
                {avatar ? (
                  <img
            ...
            <div className="flex-1 min-w-0">
              ...
              <span
                className="inline-flex items-center gap-1 mt-2 text-[11px] font-bold px-2.5 py-1 rounded-full text-emerald-300"
                style={{
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <GlassInput
                    ...
                    value={form.pan}
                    onChange={set("pan")}
                    icon={<Icon type="id" className="w-4 h-4" />}
                  />
                </div>
                ...
                <div className="pt-1">
                  ...
                  >
                    {saved ? (
                      <>
                        <Icon type="check" className="w-4 h-4" /> Saved!
                      </>
                    ) : (
                      "Save Changes"
                    )}
              ...
              {[
                {
                  ...
                  iconBorder: "rgba(80,130,220,0.20)",
                ...
                },
                {
                  ...
                  label: "2FA",
                  sub: "Enabled for login verification",
                ...
                },
                {
                  ...
                  label: "Login History",
                  sub: "Review devices and active sessions",
                  right: (
                    <button
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <Icon
                        type={row.icon}
                        className={`w-4 h-4 ${row.iconColor}`}
                      />
                    </div>
                    <div>
              ...
              {[
                {
                  ...
                  border: "rgba(80,130,220,0.20)",
                  label: "Email Notifications",
                  sub: "Updates about your account activity",
                },
                {
                  key: "smsAlerts",
                  icon: "sms",
                  ...
                  label: "SMS Alerts",
                  sub: "Receive important alerts by text",
                },
                {
                  key: "marketingEmails",
                  icon: "tag",
                  ...
                  sub: "Product updates, offers and campaigns",
                },
              ].map((item, i, arr) => (
                <div
                  key={item.key}
          ...
          <div className="space-y-3">
            {DEVICES.map((d, i) => (
              ...
              >
                ...
                {d.current ? (
                  <span
                    className="text-[10px] font-bold px-2 py-0.5 rounded-full text-emerald-300 flex-shrink-0"
                    style={{
                  ...
                  <button
                    className="text-[10px] font-bold px-2 py-0.5 rounded-full text-red-400 flex-shrink-0 hover:bg-red-500/10 transition-colors"
            ...
            <p className="text-xs text-slate-500 text-center pt-1">
              Revoking a session will sign out that device.
            </p>
          </div>
        </Modal>
      )}

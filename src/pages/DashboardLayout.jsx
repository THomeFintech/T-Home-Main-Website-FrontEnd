...
function DashboardLayout() {
  ...
  // Clear any old authentication data stored in localStorage
  ...
  localStorage.removeItem("dashboard_loans");
  localStorage.removeItem("dashboard_documents");
  localStorage.removeItem("dashboard_progress");
  localStorage.removeItem("dashboard_notifications");
  localStorage.removeItem("dashboard_advisor");

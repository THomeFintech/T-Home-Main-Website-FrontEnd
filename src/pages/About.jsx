        ...
        <section className="relative flex min-h-[72svh] items-center justify-center overflow-hidden px-6 pt-36 pb-20 text-center md:pt-32 md:pb-24">
          ...
          >
            ...
            <h1 className="mt-6 text-[42px] leading-[1.15] font-bold md:text-6xl">
              Empowering Your{" "}
              <span className="text-[#2d8bff]">Financial Future</span>
            </h1>

            <p className="mx-auto mt-5 max-w-3xl text-base leading-8 text-[#d7def3] md:text-lg">
              We simplify financial services by combining trust, speed, and
              intelligent automation so home ownership, business growth, and
              compliance services feel straightforward instead of overwhelming.
            </p>
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-12">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mx-auto mt-3 max-w-3xl text-[15px] leading-7 text-[#d7def3]">
                Founded in 2025, T-Home bridges complex financial systems and
                everyday goals with a platform designed to be transparent,
            ...
            <div className="mx-auto mt-10 grid max-w-5xl gap-8 md:grid-cols-2">
              ...
              >
                ...
                <p className="mt-4 text-[15px] leading-7 text-[#e3eeff]/88">
                  Home loans, balance transfers, compliance services, and
                  business registrations with a unified digital experience that
              ...
              >
                ...
                <p className="mt-4 text-[15px] leading-7 text-[#e3eeff]/88">
                  Clear guidance, responsive support, and smart automation built
                  around trust so every interaction feels consistent across the
                  website.
                </p>
              </motion.div>
            </div>
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-2">
              <motion.div className="rounded-[18px] border border-[#d6e6ff]/18 bg-[linear-gradient(180deg,rgba(44,66,132,0.74)_0%,rgba(25,42,102,0.68)_100%)] p-7 shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_14px_38px_rgba(0,0,0,0.34)] backdrop-blur-md">
                ...
                <p className="text-[15px] leading-7 text-[#d7def3]">
                  To simplify financial services and make home loans, taxation,
                  and business registration accessible, transparent, and
                  hassle-free.
                </p>
              </motion.div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-6 md:grid-cols-4 md:gap-6">
              {[
                ...
                >
                  ...
                  <p className="mt-3 text-sm text-[#d7def3] md:text-base">
                    {item.label}
                  </p>
                </motion.div>
              ))}

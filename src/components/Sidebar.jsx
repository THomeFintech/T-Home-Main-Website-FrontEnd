...
function NavIcon({ type }) {
  ...
  switch (type) {
    ...
    case "file":
      return (
        <svg {...p}>
          <path strokeLinecap="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586l5.414 5.414V19a2 2 0 01-2 2z" />
        </svg>
      );
    case "folder":
      return (
    ...
    case "headset":
      return (
        <svg {...p}>
          ...
          <path strokeLinecap="round" d="M21 19a2 2 0 01-2 2h-1a2 2 0 01-2-2v-3a2 2 0 012-2h3zM3 19a2 2 0 002 2h1a2 2 0 002-2v-3a2 2 0 00-2-2H3z" />
        </svg>
      );
    default:
      return null;
                ...
                <button
                  ...
                  style={
                    isActive
                      ? {
                          background:
                            "linear-gradient(135deg, rgba(63,117,203,0.34), rgba(31,74,154,0.28))",
